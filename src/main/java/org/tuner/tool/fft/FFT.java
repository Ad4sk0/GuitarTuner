package org.tuner.tool.fft;

import org.tuner.tool.fft.complex.Complex;
import org.tuner.tool.fft.complex.ComplexUtils;
...
public class FFT {
     ...
     *
     * @param signal original signal in time domain.
     * @return fft result.
     */
